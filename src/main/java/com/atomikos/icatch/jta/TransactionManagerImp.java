...

{
	...
	/**
	 * Transaction property name to indicate that the transaction is a JTA
	 * transaction. If this property is set to an arbitrary non-null value then
	 * a JTA transaction is assumed by this class. This property is used for
	 * detecting incompatible existing transactions: if a transaction exists
	 * without this property then the <b>begin</b> method will fail.
	 */
	...
	private Hashtable<String, TransactionImp> txmap_;
	...
	public static synchronized void installTransactionManager(CompositeTransactionManager ctm,
			boolean automaticResourceRegistration) {

		if (ctm == null)
			singleton_ = null;
		else
			singleton_ = new TransactionManagerImp(ctm, automaticResourceRegistration);
	...
	private TransactionManagerImp(CompositeTransactionManager ctm, boolean automaticResourceRegistration) {
		...
		txmap_ = new Hashtable<String, TransactionImp>();
	...
	public Transaction getTransaction() throws SystemException {
		...
		if (ct == null || ct.getProperty(JTA_PROPERTY_NAME) == null) // no tx
																		// for
																		// thread
																		// yet
			ret = null;
	...
	public Transaction suspend() throws SystemException {
		...
		if (ct != null) {
			...
			if (ret != null) {
				...
				{ // ------ FIX START HERE
					ret.setSuspendedStack(new Stack<Object>());
	...
	public Reference getReference() throws NamingException {
		return new Reference(getClass().getName(), new StringRefAddr("name", "TransactionManager"),
				TransactionManagerFactory.class.getName(), null);
	}
